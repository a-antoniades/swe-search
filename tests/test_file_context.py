...
def test_to_prompt_string_outcommented_code_block_with_line_numbers():
    ...
    codeblock1 = CodeBlock(type=CodeBlockType.COMMENTED_OUT_CODE, start_line=1, end_line=1, content="# ...", pre_lines=0)
    codeblock2 = CodeBlock(type=CodeBlockType.COMMENTED_OUT_CODE, start_line=3, end_line=6, content="# ...", pre_lines=2)
    codeblock3 = CodeBlock(type=CodeBlockType.COMMENT, start_line=7, end_line=8, content="# Regular comment\n# with linebreak", pre_lines=2)
    codeblock4 = CodeBlock(type=CodeBlockType.COMMENTED_OUT_CODE, start_line=9, end_line=9, content="# ...", pre_lines=1)
